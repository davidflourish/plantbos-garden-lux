  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Plantbos Gardens & Landscape" },
      {
        ...
        content:
          "Bring nature home. Abuja's premier garden center for rare plants and luxury landscaping.",
      },
...
const testimonials = [
  {
    ...
    quote:
      "Plantbos transformed our showroom. The selection is unmatched and their team is meticulous.",
  },
  {
    name: "Chinedu K.",
    role: "Homeowner, Asokoro",
    quote:
      "From design to install, every detail felt considered. Our garden is now the heart of the house.",
  },
  {
    name: "Hauwa B.",
    role: "Boutique Owner, Wuse",
    quote:
      "Their rare collection is a dream. The Pink Princess they delivered is absolutely thriving.",
  },
];
  ...
  return (
    <header
      className={`fixed inset-x-0 top-0 z-50 transition-all duration-500 ${
        scrolled
          ? "bg-background/85 backdrop-blur-xl border-b border-white/10 py-3"
          : "bg-transparent py-6"
      }`}
    >
      <div className="mx-auto flex max-w-7xl items-center justify-between px-6">
        ...
        <nav className="hidden items-center gap-10 text-sm tracking-wide text-foreground/80 md:flex">
          <a href="#shop" className="hover:text-foreground transition">
            Shop
          </a>
    ...
    <section id="top" className="relative min-h-screen w-full overflow-hidden">
      ...
      <div className="relative z-10 mx-auto flex min-h-screen max-w-5xl flex-col items-center justify-center px-6 pt-28 text-center">
        ...
        <h1 className="animate-fade-up text-balance font-display text-6xl font-light leading-[1.05] text-foreground md:text-8xl delay-200">
          Bring Nature{" "}
          <em className="not-italic text-sage italic font-light">Home.</em>
        </h1>
        <p className="mt-8 max-w-2xl animate-fade-up text-base leading-relaxed text-foreground/80 md:text-lg delay-300">
          Rare & Exotic Plants · Professional Landscaping · Abuja's Premier
          Garden Center
        </p>
        ...
        <div className="mt-16 flex animate-fade-up flex-wrap items-center justify-center gap-x-8 gap-y-3 text-xs uppercase tracking-[0.2em] text-foreground/70 delay-500">
          ...
          <span className="h-3 w-px bg-white/20" />
          <span className="flex items-center gap-2">
            <PackageCheck className="h-3.5 w-3.5" /> Kerbside Pickup
          </span>
          <span className="h-3 w-px bg-white/20" />
          <span className="flex items-center gap-2">
    ...
    <section id="services" className="bg-gradient-deep py-32">
      <div className="mx-auto max-w-7xl px-6">
        <div className="mx-auto max-w-2xl text-center">
          <p className="text-xs uppercase tracking-[0.4em] text-sage">
            What we do
          </p>
        ...
        <div className="mt-20 grid gap-px overflow-hidden rounded-3xl border border-white/10 bg-white/5 md:grid-cols-2 lg:grid-cols-4">
          {services.map(({ icon: Icon, title, desc }) => (
            ...
            >
              <Icon
                className="h-8 w-8 text-sage transition group-hover:text-terracotta"
                strokeWidth={1.25}
              />
      ...
      <div className="mx-auto max-w-7xl px-6">
        <div className="flex flex-col items-end justify-between gap-6 md:flex-row md:items-end">
          ...
          <p className="max-w-md text-sm leading-relaxed text-muted-foreground">
            A rotating selection from our greenhouse — each plant nursery-grown,
            acclimated, and ready to make a room feel alive.
          </p>
        </div>
          ...
          {plants.map((p) => (
            <article key={p.name} className="group hover-lift">
              ...
              <div className="mt-5 flex items-baseline justify-between">
                ...
                <span className="text-sm tracking-wide text-sage">
                  {p.price}
                </span>
              </div>
            </article>
        ...
        <div className="grid gap-16 lg:grid-cols-12">
          <div className="lg:col-span-5">
            ...
            <p className="mt-6 max-w-md text-sm leading-relaxed text-background/70">
              For over a decade, Abuja has trusted us to bring rare botanicals
              indoors and design landscapes that age beautifully.
            </p>
            <img
              src={logoGreen}
              alt="Plantbos"
      ...
      <div className="mx-auto grid max-w-7xl gap-16 px-6 lg:grid-cols-2 lg:items-center">
        <div>
          ...
          <p className="mt-6 max-w-md text-sm leading-relaxed text-muted-foreground">
            Step into our greenhouse in Lokogoma. Wander rows of rare tropicals,
            talk to our horticulturists, and find the piece that fits your home.
          </p>
          <ul className="mt-12 space-y-6 text-sm">
            ...
            <li className="flex gap-4">
              ...
              />
              <a
                href="tel:+2349035912539"
                className="text-foreground/90 hover:text-sage"
              >
                0903 591 2539
              </a>
            </li>
      ...
      <div className="mx-auto max-w-7xl px-6">
        ...
        <div className="mt-20 grid gap-8 md:grid-cols-3">
          {testimonials.map((t) => (
            <figure
              key={t.name}
              className="rounded-3xl bg-cream p-10 text-background shadow-soft"
            >
...
function Footer() {
  return (
    <footer
      id="contact"
      className="border-t border-white/10 bg-background pb-12 pt-24"
    >
      <div className="mx-auto max-w-7xl px-6">
        <div className="grid gap-12 md:grid-cols-12">
          <div className="md:col-span-5">
            ...
            <p className="mt-6 max-w-sm text-sm leading-relaxed text-muted-foreground">
              Abuja's premier garden center for rare botanicals, considered
              landscape design, and luxury planters.
            </p>
          </div>
          <div className="md:col-span-3">
            <h4 className="text-xs uppercase tracking-[0.3em] text-sage">
              Explore
            </h4>
            <ul className="mt-6 space-y-3 text-sm text-foreground/80">
              <li>
                <a href="#shop" className="hover:text-sage">
                  Shop Plants
                </a>
              </li>
              <li>
                <a href="#services" className="hover:text-sage">
                  Services
                </a>
              </li>
              <li>
                <a href="#visit" className="hover:text-sage">
                  Visit
                </a>
              </li>
              <li>
          ...
          <div className="md:col-span-4">
            ...
            <ul className="mt-6 space-y-3 text-sm text-foreground/80">
              ...
              <li>
                <a href="tel:+2349035912539" className="hover:text-sage">
                  0903 591 2539
                </a>
              </li>
              <li>
